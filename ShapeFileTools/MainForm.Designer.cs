namespace egis
{
    partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
	        ...
	        // menuStrip1
	        // 
	        this.menuStrip1.Items.AddRange(new System.Windows.Forms.ToolStripItem[] { this.miNewProject, this.optionsToolStripMenuItem, this.helpToolStripMenuItem });
	        ...
	        // miNewProject
	        // 
	        this.miNewProject.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] { this.newProjectToolStripMenuItem, this.miOpenProject, this.recentProjectsMenuItem, this.toolStripSeparator5, this.miOpenShapeFile, this.addXYDatacsvToolStripMenuItem, this.toolStripSeparator4, this.miSaveProject, this.saveProjectAsToolStripMenuItem, this.exportProjectToolStripMenuItem, this.exportProjectforUseInWebEditionAsSingleZIPFileToolStripMenuItem, this.toolStripSeparator7, this.saveMapImageToolStripMenuItem, this.toolStripSeparator11, this.printToolStripMenuItem });
	        ...
	        this.optionsToolStripMenuItem.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] { this.miMapBackgroundColor, this.miMercatorProjection, this.setCRSToolStripMenuItem, this.setMapCRSFromFirstLayerToolStripMenuItem, this.toolStripSeparator8, this.renderQualityToolStripMenuItem, this.useNativeFileMappingToolStripMenuItem, this.loadShapeFilesInMemoryToolStripMenuItem, this.toolStripSeparator9, this.displayShapeAttributesWindowToolStripMenuItem, this.disablePanSelectToolStripMenuItem, this.viewAttributesToolStripMenuItem, this.miZoomToExtentWhenCtrlkeyDown, this.mouseWheelZoomModeToolStripMenuItem });
	        ...
	        // 
	        this.renderQualityToolStripMenuItem.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] { this.highToolStripMenuItem, this.lowToolStripMenuItem, this.autoToolStripMenuItem });
	        ...
	        // 
	        this.mouseWheelZoomModeToolStripMenuItem.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] { this.defaultMouseWheelZoomMenuItem, this.reverseMouseWheelZoomMenuItem, this.disableMouseWheelZoomMenuItem });
	        ...
	        // 
	        this.helpToolStripMenuItem.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] { this.aboutMenuItem });
	        ...
	        // 
	        this.shapeFileRenderPropertyGrid.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom) | System.Windows.Forms.AnchorStyles.Left)));
	        ...
	        this.mainToolStrip.Items.AddRange(new System.Windows.Forms.ToolStripItem[] { this.newToolStripButton, this.openToolStripButton1, this.saveToolStripButton, this.toolStripSeparator, this.tsBtnPanLeft, this.tsBtnPanRight, this.tsBtnPanUp, this.tsBtnPanDown, this.toolStripSeparator3, this.tsBtnZoomIn, this.tsBtnZoomOut, this.tsBtnZoomFull, this.toolStripSeparator1, this.tsBtnSelectRect, this.tsBtnSelectCircle, this.toolStripSeparator10, this.toolStripLabel2, this.tsTxtFind, this.toolStripLabel3, this.tscbSearchLayers, this.toolStripSeparator2, this.toolStripDropDownButton1, this.toolStripSeparator6, this.helpToolStripButton });
	        ...
	        this.tscbSearchLayers.Items.AddRange(new object[] { "selected layer", "all layers" });
	        ...
	        this.toolStripDropDownButton1.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] { this.cbBaseMapLayerDataSource });
	        ...
	        // statusStrip1
	        // 
	        this.statusStrip1.Items.AddRange(new System.Windows.Forms.ToolStripItem[] { this.toolStripStatusLabel1, this.tsLabelCurrentZoom, this.tsLabelVisibleArea, this.tsLblMapMousePos, this.mainProgressBar, this.tsLblMapCRS, this.tsLblSelectMessage });
	        ...
	        // sfMap1
	        // 
	        this.sfMap1.Anchor = ((System.Windows.Forms.AnchorStyles)((((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom) | System.Windows.Forms.AnchorStyles.Left) | System.Windows.Forms.AnchorStyles.Right)));
